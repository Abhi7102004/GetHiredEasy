    ...
    <AnimatePresence>
      {open && (
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogContent
            className={`sm:max-w-[95%] md:max-w-[600px] lg:max-w-[800px] w-full bg-[url('https://i.pinimg.com/736x/bb/f3/7f/bbf37fb8161a5b94e57c7353a64dee6f.jpg')] dark:bg-[url('https://images.unsplash.com/photo-1569470451072-68314f596aec?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8Mnx8fGVufDB8fHx8fA%3D%3D')] text-gray-800 dark:text-gray-100 rounded-xl overflow-hidden shadow-2xl`}
          >
            <motion.div
